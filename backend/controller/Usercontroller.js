...
const cart = async (req,res)=>{
  try{
    ...
    if(!productId)
    {
      return res.status(400).json({ message: "productId is requare", success: false });
    }
...
export { login, register, forgotpassword, resetpassword, adminlogin, logout, getname ,cart};